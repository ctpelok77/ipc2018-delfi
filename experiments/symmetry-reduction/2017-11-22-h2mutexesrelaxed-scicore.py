...
def main(revisions=None):
    ...
    configs = {
        IssueConfig('translate-h2mutexesrelaxed', ['--translate-options', '--h2-mutexes', '--only-positive-literals'], driver_options=['--translate', '--translate-time-limit', '29m', '--translate-memory-limit', '3G']),
        #IssueConfig('translate-reduced-h2mutexesrelaxed', ['--translate-options', '--compute-symmetries', '--bliss-time-limit', '300', '--only-object-symmetries', '--compute-symmetric-object-sets', '--symmetry-reduced-grounding-for-h2-mutexes', '--h2-mutexes', '--only-positive-literals'], driver_options=['--translate', '--translate-time-limit', '29m', '--translate-memory-limit', '3G']),
        IssueConfig('translate-reduced-h2mutexesrelaxed-nogoal', ['--translate-options', '--compute-symmetries', '--bliss-time-limit', '300', '--only-object-symmetries', '--compute-symmetric-object-sets', '--symmetry-reduced-grounding-for-h2-mutexes','--h2-mutexes', '--only-positive-literals', '--do-not-stabilize-goal'], driver_options=['--translate', '--translate-time-limit', '29m', '--translate-memory-limit', '3G']),
        #IssueConfig('translate-reduced-h2mutexesrelaxed-expand', ['--translate-options', '--compute-symmetries', '--bliss-time-limit', '300', '--only-object-symmetries', '--compute-symmetric-object-sets', '--symmetry-reduced-grounding-for-h2-mutexes', '--h2-mutexes', '--only-positive-literals', '--expand-reduced-h2-mutexes'], driver_options=['--translate', '--translate-time-limit', '29m', '--translate-memory-limit', '3G']),
        IssueConfig('translate-reduced-h2mutexesrelaxed-expand-nogoal', ['--translate-options', '--compute-symmetries', '--bliss-time-limit', '300', '--only-object-symmetries', '--compute-symmetric-object-sets', '--symmetry-reduced-grounding-for-h2-mutexes','--h2-mutexes', '--only-positive-literals', '--expand-reduced-h2-mutexes', '--do-not-stabilize-goal'], driver_options=['--translate', '--translate-time-limit', '29m', '--translate-memory-limit', '3G']),
    }
