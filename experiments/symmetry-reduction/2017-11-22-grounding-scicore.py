...
def main(revisions=None):
    ...
    environment = BaselSlurmEnvironment(qos='30min', partition='scicore', email="silvan.sievers@unibas.ch", export=["PATH"])
    ...
    configs = {
        IssueConfig('translate', [], driver_options=['--translate', '--translate-time-limit', '29m', '--translate-memory-limit', '3G']),
        #IssueConfig('translate-reduced-grounding', ['--translate-options', '--compute-symmetries', '--bliss-time-limit', '300', '--only-object-symmetries', '--compute-symmetric-object-sets', '--symmetry-reduced-grounding'], driver_options=['--translate', '--translate-time-limit', '29m', '--translate-memory-limit', '3G']),
        IssueConfig('translate-reduced-grounding-nogoal', ['--translate-options', '--compute-symmetries', '--bliss-time-limit', '300', '--only-object-symmetries', '--compute-symmetric-object-sets', '--symmetry-reduced-grounding', '--do-not-stabilize-goal'], driver_options=['--translate', '--translate-time-limit', '29m', '--translate-memory-limit', '3G']),
        #IssueConfig('translate-reduced-grounding-expand', ['--translate-options', '--compute-symmetries', '--bliss-time-limit', '300', '--only-object-symmetries', '--compute-symmetric-object-sets', '--symmetry-reduced-grounding', '--expand-reduced-task'], driver_options=['--translate', '--translate-time-limit', '29m', '--translate-memory-limit', '3G']),
        IssueConfig('translate-reduced-grounding-expand-nogoal', ['--translate-options', '--compute-symmetries', '--bliss-time-limit', '300', '--only-object-symmetries', '--compute-symmetric-object-sets', '--symmetry-reduced-grounding', '--expand-reduced-task', '--do-not-stabilize-goal'], driver_options=['--translate', '--translate-time-limit', '29m', '--translate-memory-limit', '3G']),
    }
