...
def main(revisions=None):
    ...
    configs = {
        IssueConfig('translate-symmetries', ['--translate-options', '--compute-symmetries', '--bliss-time-limit', '300', '--do-not-stabilize-goal', '--only-object-symmetries', '--compute-symmetric-object-sets'], driver_options=['--translate', '--translate-time-limit', '30m', '--translate-memory-limit', '3G']),
    }
    ...
    exp.add_absolute_report_step(attributes=attributes,filter_algorithm=[
        '{}-translate-symmetries'.format(REVISION),
