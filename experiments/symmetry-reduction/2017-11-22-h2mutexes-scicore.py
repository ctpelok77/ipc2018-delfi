...
def main(revisions=None):
    ...
    if is_test_run():
        suite = ['gripper:prob01.pddl','gripper:prob02.pddl','openstacks:p01.pddl','openstacks:p02.pddl']
        environment = LocalEnvironment(processes=4)

    configs = {
        IssueConfig('translate-h2mutexes', ['--translate-options', '--h2-mutexes'], driver_options=['--translate', '--translate-time-limit', '29m', '--translate-memory-limit', '3G']),
        #IssueConfig('translate-reduced-h2mutexes', ['--translate-options', '--compute-symmetries', '--bliss-time-limit', '300', '--only-object-symmetries', '--compute-symmetric-object-sets', '--symmetry-reduced-grounding-for-h2-mutexes', '--h2-mutexes'], driver_options=['--translate', '--translate-time-limit', '29m', '--translate-memory-limit', '3G']),
        IssueConfig('translate-reduced-h2mutexes-nogoal', ['--translate-options', '--compute-symmetries', '--bliss-time-limit', '300', '--only-object-symmetries', '--compute-symmetric-object-sets', '--symmetry-reduced-grounding-for-h2-mutexes','--h2-mutexes', '--do-not-stabilize-goal'], driver_options=['--translate', '--translate-time-limit', '29m', '--translate-memory-limit', '3G']),
        #IssueConfig('translate-reduced-h2mutexes-expand', ['--translate-options', '--compute-symmetries', '--bliss-time-limit', '300', '--only-object-symmetries', '--compute-symmetric-object-sets', '--symmetry-reduced-grounding-for-h2-mutexes', '--h2-mutexes', '--expand-reduced-h2-mutexes'], driver_options=['--translate', '--translate-time-limit', '29m', '--translate-memory-limit', '3G']),
        IssueConfig('translate-reduced-h2mutexes-expand-nogoal', ['--translate-options', '--compute-symmetries', '--bliss-time-limit', '300', '--only-object-symmetries', '--compute-symmetric-object-sets', '--symmetry-reduced-grounding-for-h2-mutexes','--h2-mutexes', '--expand-reduced-h2-mutexes', '--do-not-stabilize-goal'], driver_options=['--translate', '--translate-time-limit', '29m', '--translate-memory-limit', '3G']),
    }
