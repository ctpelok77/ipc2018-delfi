...
def main(revisions=None):
    ...
    configs = {
        IssueConfig('translate-reduced-grounding-noexpand', ['--translate-options', '--compute-symmetries', '--only-object-symmetries', '--compute-symmetric-object-sets', '--symmetry-reduced-grounding', '--bliss-time-limit', '300', ], driver_options=['--translate', '--translate-time-limit', '30m', '--translate-memory-limit', '3G']),
        IssueConfig('translate-reduced-grounding--noexpandnogoal', ['--translate-options', '--compute-symmetries', '--only-object-symmetries', '--compute-symmetric-object-sets', '--symmetry-reduced-grounding', '--do-not-stabilize-goal', '--bliss-time-limit', '300', ], driver_options=['--translate', '--translate-time-limit', '30m', '--translate-memory-limit', '3G']),
    }
    ...
    exp.add_absolute_report_step(attributes=attributes,filter_algorithm=[
        '{}-translate-reduced-grounding-noexpand'.format(REVISION),
        '{}-translate-reduced-grounding--noexpandnogoal'.format(REVISION),
    ])
