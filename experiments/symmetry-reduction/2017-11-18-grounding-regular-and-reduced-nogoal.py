...
def main(revisions=None):
    ...
    configs = {
        ...
        IssueConfig('translate-reduced-grounding-nogoal', ['--translate-options', '--compute-symmetries', '--only-object-symmetries', '--compute-symmetric-object-sets', '--symmetry-reduced-grounding', '--expand-reduced-task', '--do-not-stabilize-goal', '--bliss-time-limit', '300', ], driver_options=['--translate', '--translate-time-limit', '30m', '--translate-memory-limit', '3G']),
    }
