...
def main(revisions=None):
    ...
    configs = {
        ...
        IssueConfig('translate-symmetric-object-sets', ['--translate-options', '--compute-symmetries', '--stabilize-initial-state', '--only-object-symmetries', '--compute-symmetric-object-sets', '--bliss-time-limit', '300', ], driver_options=['--translate', '--translate-time-limit', '30m', '--translate-memory-limit', '2G']),
    ...
    max_predicate_arity = Attribute('max_predicate_arity', absolute=True, min_wins=True)
    max_operator_arity = Attribute('max_operator_arity', absolute=True, min_wins=True)
    ...
    extra_attributes = [
        ...
        max_predicate_arity,
        max_operator_arity,
        has_symmetry_reduction_potential,
    ]
