...
def main(revisions=None):
    ...
    configs = {
        ...
        IssueConfig('translate-symmetry-reduction-expansion', ['--translate-options', '--compute-symmetries', '--stabilize-initial-state', '--only-object-symmetries', '--compute-symmetric-object-sets', '--symmetry-reduction', '--expand-reduced-task', '--bliss-time-limit', '300', ], driver_options=['--translate', '--translate-time-limit', '30m', '--translate-memory-limit', '3G']),
    }
    ...
    exp.add_absolute_report_step(attributes=attributes,filter_algorithm=[
        ...
        '{}-translate-symmetry-reduction-expansion'.format(REVISION),
