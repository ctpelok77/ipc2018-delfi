...
def main(revisions=None):
    ...
    time_grounding_program = Attribute('time_grounding_program', absolute=False, min_wins=True, functions=[geometric_mean])
    time_grounding_model = Attribute('time_grounding_model', absolute=False, min_wins=True, functions=[geometric_mean])
    time_grounding_expand = Attribute('time_grounding_expand', absolute=False, min_wins=True, functions=[geometric_mean])
    time_h2mutexes_program = Attribute('time_h2mutexes_program', absolute=False, min_wins=True, functions=[geometric_mean])
    time_h2mutexes_model = Attribute('time_h2mutexes_model', absolute=False, min_wins=True, functions=[geometric_mean])
    time_h2mutexes_expand = Attribute('time_h2mutexes_expand', absolute=False, min_wins=True, functions=[geometric_mean])
